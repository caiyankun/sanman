...
SWFUpload.prototype.getFlashHTML = function () {
	...
	return ['<object id="', this.movieName, '"' + classid + ' type="appsanmantech/x-shockwave-flash" data="', this.settings.flash_url, '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">',
