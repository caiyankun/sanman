...
SWFUpload.prototype.getFlashHTML = function (flashVersion) {
	if(BROWSER.ie && !BROWSER.opera) {
		...
		return ['<object id="', this.movieName, '" type="appsanmantech/x-shockwave-flash" data="', (this.support.imageResize ? this.settings.flash_url : this.settings.flash9_url), '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">',
